...
_POLICY_OVERRIDES: dict[str, ToolPolicy] = {
    ...
    "set_chart_view": _policy(
        "set_chart_view",
        read_only=False,
        persistent=True,
    ),
    "add_watchlist_symbol": _policy(
        "add_watchlist_symbol",
        read_only=False,
        persistent=True,
    ),
    "remove_watchlist_symbol": _policy(
        "remove_watchlist_symbol",
        read_only=False,
        persistent=True,
    ),
    "set_watchlist": _policy(
        "set_watchlist",
        read_only=False,
        persistent=True,
    ),
    "taskboard_start_work": _policy(
        "taskboard_start_work",
        read_only=False,
        persistent=True,
        external_side_effects=True,
        requires_approval_in_auto=True,
    ),
    "taskboard_comment": _policy(
        "taskboard_comment",
        read_only=False,
        persistent=True,
        external_side_effects=True,
    ...
    "taskboard_create_action_item": _policy(
        "taskboard_create_action_item",
        read_only=False,
        persistent=True,
        external_side_effects=True,
        requires_approval_in_auto=True,
    ),
    "git_prepare_task_workspace": _policy(
        "git_prepare_task_workspace",
        read_only=False,
        persistent=True,
        external_side_effects=True,
        long_running=True,
